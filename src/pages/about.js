          ...
          <header className="header">
            <div className="row text-center">
              <img
                ...
                alt="Gustavo Gard"
              />
              <h1>Hey, I'm Gustavo. Nice having you here.</h1>
            </div>
          </header>
          <Separator />
          <main role="main">
            <div className="row about-section">
              ...
              <div className="medium-10">
                ...
                <p>
                  I like{' '}
                  <a href="http://slides.com/gusgard">speaking</a> to meetups
                  ...
                  {' '}<a href="https://github.com/gusgard">Github</a>. Along with
                ...
                <p>
                  This site is being generated using Gatsby.js and you can find the source on
                   {' '}<a href="https://github.com/gusgard/gusgard.com">{' '}GitHub</a>.
                </p>
                <p>
            ...
            <div className="row about-section">
              ...
              <div className="medium-10">
                <div className="row">
                  <div className="medium-4">
                    <a
                      href="http://slides.com/gusgard/javascript-101"
                      target="_blank"
                    >
                      JavaScript 101
                    </a>
                ...
                <div className="row">
                  <div className="medium-4">
                    <a
                      href="https://slides.com/gusgard/microservices"
                      target="_blank"
                    >
